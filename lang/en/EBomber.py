...
kol = input("\n \033[31mTime of attacking (Sec) (Enter more than 30 | 0 - infinite) > \033[0m\033[94m ")
if kol == str(0):
...
CLOSE_AFTER = kol
call = input("\n \033[31mType of attacking (1 - Call attack (NOT WORKING) | 2 - SMS Attack) > \033[0m\033[94m")
if call == str(1):
    os.system("clear")
